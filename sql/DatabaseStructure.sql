...
GRANT INSERT, SELECT, UPDATE ON TABLE `SchedulerProDB`.`Users` TO 'login';
SET SQL_MODE = '';
GRANT USAGE ON *.* TO main;
 DROP USER main;
SET SQL_MODE='TRADITIONAL,ALLOW_INVALID_DATES';
CREATE USER 'main' IDENTIFIED BY 'main';

GRANT INSERT, SELECT, UPDATE ON TABLE `SchedulerProDB`.`Users` TO 'main';
GRANT SELECT, INSERT, TRIGGER, UPDATE ON TABLE `SchedulerProDB`.* TO 'main';
SET SQL_MODE = '';
...
GRANT ALL ON `SchedulerProDB`.* TO 'owner';
